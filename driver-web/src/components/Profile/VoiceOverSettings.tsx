...
const STORAGE_KEY = 'driver.voiceOver';
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 sm:px-6 py-4 flex items-center">
        ...
        <h1 className="flex-1 text-center text-xl font-extrabold text-gray-900 -ml-8">Voice Over</h1>
      </div>

      <div className="divide-y divide-white">
        <RadioRow label="On" active={enabled} onClick={() => setEnabled(true)} />
        <div className="h-2 bg-white" />
        <RadioRow label="Off" active={!enabled} onClick={() => setEnabled(false)} />
      </div>
    </div>
  );
};
