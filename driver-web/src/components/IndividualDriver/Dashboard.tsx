...
import { INDIVIDUAL_DASHBOARD_MENU_ITEMS, RIDE_MAP_MARKERS, type MenuItemConfig, type MapMarker } from '../../constants';
...
const Dashboard: React.FC = () => {
  ...
  const menuItems = INDIVIDUAL_DASHBOARD_MENU_ITEMS.map((item: MenuItemConfig) => ({
    ...item,
    arrow: true,
    // Add progress text for Set Target card only
    ...(item.id === 'performance' ? { rightText: "You're 60% of the way there!" } : {})
  }));
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="bg-white w-full lg:w-96 p-4 lg:p-6">
