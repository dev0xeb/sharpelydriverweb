...
interface UploadState {
  ...
  vehicleOwnership: File | null;
}

const DriverForm: React.FC<DriverFormProps> = ({ onBack, onNext }) => {
      ...
      <div className="w-full max-w-md lg:max-w-4xl bg-white rounded-2xl shadow-none lg:shadow-lg p-0 lg:p-10 flex flex-col items-center">
        ...
        <div className="w-full mt-6 lg:max-w-2xl lg:mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {renderUploadSection(
              "Driver's Licenses",
              "Please provide a driver license showing a clear picture of your license number, name and date of birth",
              "driversLicense"
            )}

            {renderUploadSection(
              "Driver's Profile Photo",
              "Please provide a very clear picture of just your face",
              "profilePhoto"
            )}

            {renderUploadSection(
              "Exterior Photo of Car",
              "Please provide a very clear picture of the out side of your vehicle showing plate number",
              "exteriorPhoto"
            )}
